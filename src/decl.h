...
inline const bool isWithinPrecisionInterval(TReal a, TReal b, unsigned int interval_size = FLOAT_PREC_INTVL )
{
...
// template<typename TReal>
// inline const bool isWithinPrecisionInterval(TReal a, TReal b )
// {
// return isWithinPrecisionInterval(a,b,FLOAT_PREC_INTVL);
// }
